...
<head>
    ...
    <!-- Theme CSS -->
    <link href="<?php echo e(url('public')); ?>/css/style.css" rel="stylesheet" media="screen">
    <!-- Responsive CSS -->
    <link href="<?php echo e(url('public')); ?>/css/theme-responsive.css" rel="stylesheet" media="screen">
    ...
    <?php echo $__env->yieldContent('customCss'); ?>
            <!-- Head Libs -->
    <script src="<?php echo e(url('public')); ?>/js/libs/modernizr.js"></script>
    <!--[if IE]>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-5">
                <div class="logo">
                    <a href="<?php echo e(url('/')); ?>">
                        <img src="<?php echo e(url('public')); ?>/images/logo.png" class="img-responsive" alt="green">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-7">
                <div class="info-login">
                    <div class="head-info-login">
                        ...
                        <span><a href="<?php echo e(asset('/login')); ?>"> লগইন করুন </a></span>
                    </div>
                        ...
                        <form class="form-horizontal" id="head_login" role="form" method="POST"
                            ...
                            <?php if($errors->has('phone')): ?>
                                <span class="help-block">
                                        <strong style="color: white"><?php echo e('মোবাইল নম্বর অথবা পাসওয়ার্ড সঠিক নয়'); ?></strong>
                                    </span>
                            <?php endif; ?>
                        </form>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div id="navbar-collapse-1" class="navbar-collapse collapse">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <!-- Services Nav Item -->
                                <li class="dropdown">
                                    <a href="<?php echo e(url('/achievement/details')); ?>">
                                        অর্জন
                                    </a>
                                </li>
                                ...
                                <!-- Portfolio Nav Item -->
                                <li class="dropdown">
                                    <a href="<?php echo e(url('/current_work/details')); ?>">
                                        চলমান কার্যক্রম
                                    </a>
                                </li>
                                ...
                                <!-- News Nav Item -->
                                <li class="dropdown">
                                    <a href="<?php echo e(url('/rules/details')); ?>">
                                        সমবায় নীতি
                                    </a>
                                </li>
                                <!-- End News Nav Item -->
                                ...
                                <li class="dropdown yamm-fw">
                                    <a href="<?php echo e(url('/about_us/details')); ?>">
                                        আমাদের কথা
                                    </a>
                                </li>
                ...
                <ul class="owl-carousel carousel-sponsors tooltip-hover" id="carousel-sponsors">
                    <li data-toggle="tooltip" title data-original-title="Name Sponsor">
                        <a href="#" class="tooltip_hover" title="Name Sponsor"><img
                                    src="<?php echo e(url('public')); ?>/images/sponsors/1.png" alt="Image"></a>
                    </li>
                    <li data-toggle="tooltip" title data-original-title="Name Sponsor">
                        <a href="#" class="tooltip_hover" title="Name Sponsor"><img
                                    src="<?php echo e(url('public')); ?>/images/sponsors/2.png" alt="Image"></a>
                    </li>
                    <li data-toggle="tooltip" title data-original-title="Name Sponsor">
                        <a href="#" class="tooltip_hover" title="Name Sponsor"><img
                                    src="<?php echo e(url('public')); ?>/images/sponsors/3.png" alt="Image"></a>
                    </li>
                    <li data-toggle="tooltip" title data-original-title="Name Sponsor">
                        <a href="#" class="tooltip_hover" title="Name Sponsor"><img
                                    src="<?php echo e(url('public')); ?>/images/sponsors/4.png" alt="Image"></a>
                    </li>
                    <li data-toggle="tooltip" title data-original-title="Name Sponsor">
                        <a href="#" class="tooltip_hover" title="Name Sponsor"><img
                                    src="<?php echo e(url('public')); ?>/images/sponsors/5.png" alt="Image"></a>
                    </li>
                    <li data-toggle="tooltip" title data-original-title="Name Sponsor">
                        <a href="#" class="tooltip_hover" title="Name Sponsor"><img
                                    src="<?php echo e(url('public')); ?>/images/sponsors/6.png" alt="Image"></a>
                    </li>
                    <li data-toggle="tooltip" title data-original-title="Name Sponsor">
                        <a href="#" class="tooltip_hover" title="Name Sponsor"><img
                                    src="<?php echo e(url('public')); ?>/images/sponsors/7.png" alt="Image"></a>
                    </li>
                    <li data-toggle="tooltip" title data-original-title="Name Sponsor">
                        <a href="#" class="tooltip_hover" title="Name Sponsor"><img
                                    src="<?php echo e(url('public')); ?>/images/sponsors/8.png" alt="Image"></a>
                    </li>
                </ul>
                <!-- End Sponsors Zone-->
            </div>
    ...
    <footer id="footer">
                ...
                <ul id="testimonials" class="testimonials padding-top">
                    <li>
                        <blockquote><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque rutrum
                                pellentesque!.</p>
                            <img src="<?php echo e(url('public')); ?>/images/testimonials/1.jpg" alt="">
                            <strong>Federic Gordon</strong><a href="#">@iwthemes</a></blockquote>
                    </li>
                    <li>
                        <blockquote><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque rutrum
                                pellentesque!.</p>
                            <img src="<?php echo e(url('public')); ?>/images/testimonials/2.jpg" alt="">
                            <strong>Federic Gordon</strong><a href="#">@iwthemes</a></blockquote>
                    </li>
                    <li>
                        <blockquote><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque rutrum
                                pellentesque!.</p>
                            <img src="<?php echo e(url('public')); ?>/images/testimonials/3.jpg" alt="">
                            <strong>Federic Gordon</strong><a href="#">@iwthemes</a></blockquote>
                    </li>
                    <li>
                        <blockquote><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque rutrum
                                pellentesque!.</p>
                            <img src="<?php echo e(url('public')); ?>/images/testimonials/4.jpg" alt="">
                            <strong>Federic Gordon</strong><a href="#">@iwthemes</a></blockquote>
                    </li>
                </ul>
            </div>
            ...
            <div class="row paddings-mini">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="border-right txt-right">
                        <img style="margin: 0 auto;" src="<?php echo e(url('public')); ?>/images/logo.png" class="img-responsive"
                             alt="logo">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="border-right border-right-none">
                        ...
                        <ul class="list-styles">
                            <li><i class="fa fa-check"></i> <a href="<?php echo e(url('/')); ?>">হোম</a></li>
                            <li><i class="fa fa-check"></i> <a href="<?php echo e(url('gallery')); ?>">তথ্য ও ছবি</a></li>
                            <li><i class="fa fa-check"></i> <a href="<?php echo e(url('/about_us/details')); ?>">আমাদের কথা</a></li>
                            <li><i class="fa fa-check"></i> <a href="<?php echo e(url('/rules/details')); ?>"> সমবায় নীতি </a></li>
                            <li><i class="fa fa-check"></i> <a href="<?php echo e(url('contact_us')); ?>"> যোগাযোগ করুন </a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="border-right txt-right">
                        ...
                        <form id="" class="newsletterForm" action="<?php echo e('/newsletter'); ?>" method="post">
                            <?php echo e(csrf_field()); ?>
                        ...
                        <div id="result-newsletter"><?php echo $__env->make('includes.flashMessage', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></div>
                    </div>
                </div>
        ...
        <div class="footer-down">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        powered by <img src="<?php echo e(url('public')); ?>/images/gnt.png" alt="gnt">
                    </div>
                    <div class="col-md-5">
...
<!-- ======================= JQuery libs =========================== -->
<!-- jQuery local-->
<script type="text/javascript" src="<?php echo e(url('public')); ?>/js/libs/jquery/jquery-1.11.2.min.js"></script>
<script type="text/javascript" src="<?php echo e(url('public')); ?>/js/libs/totop/jquery.ui.totop.js"></script>
<script type="text/javascript" src="<?php echo e(url('public')); ?>/js/libs/carousel/owl.carousel.min.js"></script>
<script type="text/javascript" src="<?php echo e(url('public')); ?>/js/libs/parallax/parallax.min.js"></script>
<script type="text/javascript" src="<?php echo e(url('public')); ?>/js/libs/bootstrap/bootstrap.min.js"></script>

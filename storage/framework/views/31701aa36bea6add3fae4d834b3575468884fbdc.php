    ...
    <section>
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <form action="<?php echo e(url('admin/report/depositReport')); ?>" method="post">
                        ...
                        <div class="col-sm-1 form-group " style="padding-left: 0px;">
                            <a href="<?php echo e(url('admin/report/depositReportPdf')); ?>" class="btn btn-success btn-sm" role="button"><i class="fa fa-file-pdf-o"></i>পি ডি এফ</a>
                            </button>
                        </div>
                    </form>

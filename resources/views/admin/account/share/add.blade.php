    ...
    <section>
        <div class="card">
            <div class="card-body">
                ...
                <div class="alert alert-callout alert-success "><b class="text-lg">শেয়ার ফান্ড গ্রহণ</b>
                </div>
                <div class="">
                    <form action="{{ url('/admin/collect_share') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <!---date--->
                        <div class="row">

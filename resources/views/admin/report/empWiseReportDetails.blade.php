                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        <tr>
                            ...
                            <td style="text-align: center">{{$page_title}}</td>
                        </tr>
                            ...
                            @foreach($page_data as $key=>$row)
                                <tr>
                                    <td style="text-align: center">
                                        {{str_replace(range(0,9),$bn_digits,$key+1)}}
                                    </td>
                                    <td style="text-align: center">
                                        {{str_replace(range(0,9),$bn_digits,$row->transaction_date)}}
                                    </td>
                                    <td style="text-align: left">
                                        {{str_replace(range(0,9),$bn_digits,$row->description)}}
                                    </td>
                                    <td style="text-align: right">
                                        {{str_replace(range(0,9),$bn_digits,$row->debit)}}
                                    </td>
                                </tr>
                            @endforeach
                            <tr>

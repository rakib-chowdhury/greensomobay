...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2017 at 03:29 PM
...
CREATE TABLE `loan_list` (
  `id` int(11) NOT NULL,
  `loan_req_id` int(11) NOT NULL,
  `member_id` int(11) NOT NULL,
  `loan_type` int(11) NOT NULL COMMENT 'prokolpo type',
  `loan_amount` double NOT NULL,
  `service_charge` double NOT NULL,
  `insurance` double NOT NULL,
  `loan_start_date` date NOT NULL,
  `loan_end_date` date NOT NULL,
  `loan_ended_at` date DEFAULT NULL,
...
(1, 1, '2017-04-27', 'member 1', 'member 1', 'member 1', 'member 1', 'member 1', 'member 1', 'member 1', 447, 59, 7, 'member 1', 'member 1', 447, 59, 7, 'পুরুষ', '2000-01-02', 'bangladeshi', 'মুসলিম', 3, 2, 'বিবাহিত', 'member 1', 'member 1', 'nominee_1.jpg', 'applicant_sign_1.jpg', '2017-04-16 18:00:00', '2017-04-17 05:15:34'),

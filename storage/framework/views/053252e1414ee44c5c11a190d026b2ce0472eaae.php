<?php $__env->startSection('customCss'); ?>
    <link rel="stylesheet" href="<?php echo e(url('public')); ?>/css/responsive/responsiveslides.css">
    ...
    <div class="content_info">
        ...
        <div class="slides_area">
            <ul class="slides">
                <li>
                    <img src="<?php echo e(url('public')); ?>/images/slide/slide-01.jpg" alt="" title=""/>
                    <div class="caption">
                        <h2>গ্রীন</h2>
                ...
                <li>
                    <img src="<?php echo e(url('public')); ?>/images/slide/slide-02.jpg" alt="" title=""/>
                    <div class="caption">
                        <h2>গ্রীন</h2>
                        <p>মাল্টিপারপাস কো - অপারেটিভ সোসাইটি </p>
                    </div>
                ...
                <li>
                    <img src="<?php echo e(url('public')); ?>/images/slide/slide-03.jpg" alt="" title=""/>
                    <div class="caption">
                        <h2>গ্রীন</h2>
                        <p>মাল্টিপারপাস কো - অপারেটিভ সোসাইটি </p>
                    </div>
                ...
                <li>
                    <img src="<?php echo e(url('public')); ?>/images/slide/slide-04.jpg" alt="" title=""/>
                    <div class="caption">
                        <h2>গ্রীন</h2>
                        <p>মাল্টিপারপাস কো - অপারেটিভ সোসাইটি </p>
                    </div>
                        ...
                        <div class="row boxes-services">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="item-boxed-service">
                                    ...
                                    <a href="<?php echo e(url('/member_admission')); ?>">বিস্তারিত</a>
                                </div>
                            </div>
    ...
    <div class="parallax-window" data-parallax="scroll"
         data-image-src="<?php echo e(url('public')); ?>/images/parallax-img/parallax-04.jpg">
        <!-- Content Parallax-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <ul class="image-clients-downloads">
                        <li><img src="<?php echo e(url('public')); ?>/images/clients-downloads/1.jpg" alt=""></li>
                        <li><img src="<?php echo e(url('public')); ?>/images/clients-downloads/2.jpg" alt=""></li>
                        <li><img src="<?php echo e(url('public')); ?>/images/clients-downloads/3.jpg" alt=""></li>
                        <li><img src="<?php echo e(url('public')); ?>/images/clients-downloads/4.jpg" alt=""></li>
                        <li><img src="<?php echo e(url('public')); ?>/images/clients-downloads/5.jpg" alt=""></li>
                        <li><img src="<?php echo e(url('public')); ?>/images/clients-downloads/6.jpg" alt=""></li>
                        <li><img src="<?php echo e(url('public')); ?>/images/clients-downloads/7.jpeg" alt=""></li>
                        <li><img src="<?php echo e(url('public')); ?>/images/clients-downloads/8.jpg" alt=""></li>
                    </ul>
    ...
    <?php echo $__env->make('includes.check_member', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('customJs'); ?>
    <script type="text/javascript" src="<?php echo e(url('public')); ?>/js/libs/responsive/responsiveslides.min.js"></script>
